...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "rxjs/add/observable/zip", "ionic-angular", "rxjs/Observable", "./image-viewer-transitions"], factory);
    }
    ...
    var ImageViewerImpl = (function (_super) {
        ...
        function ImageViewerImpl(app, component, opts, config) {
            ...
            _this.willEnter.subscribe(function () { return _this.handleHighResImageLoad(opts.fullResImage); });
            return _this;
        }
        ...
        ImageViewerImpl.prototype.handleHighResImageLoad = function (fullResImage) {
            ...
            if (!image.complete) {
                ...
                Observable_1.Observable.zip(onLoadObservable, this.didEnter)
                    .subscribe(function () { return _this.instance.updateImageSrcWithTransition(fullResImage); });
            }
            else {
