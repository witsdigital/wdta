...
(function (factory) {
    ...
    var ImageViewerEnter = (function (_super) {
        ...
        ImageViewerEnter.prototype.init = function () {
            ...
            var imgElement = ele.querySelector('.image');
            var backdrop = new ionic_angular_1.Animation(this.plt, ele.querySelector('ion-backdrop'));
    ...
    var ImageViewerLeave = (function (_super) {
        ...
        ImageViewerLeave.prototype.init = function () {
            ...
            var imageElement = ele.querySelector('.image');
            var offsetY = 0;
            var imageYOffset = imageElement.style[css.transform];
            if (imageYOffset) {
            ...
            var backdrop = new ionic_angular_1.Animation(this.plt, ele.querySelector('ion-backdrop'));
            var image = new ionic_angular_1.Animation(this.plt, imageElement);
